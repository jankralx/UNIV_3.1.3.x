...
;==============================================================================
    ...
    #include "univ_3-1-3-0-rev0.inc"                         ;project variables
...
;            |____|___________________________________ take setpoint last saved value at power up
            org     0xF00080
    DE      0x03,0x00,0x00,0x00,0x00,0x00
...
FLASH       code    0x008600    
    ...
    ;controller coolong pwm mapping table
    DB      0x08,0x10,0x18,0x20,0x28,0x30,0x38,0x40,0x48,0x50,0x58,0x60,0x68,0x70,0x78,0x80
    DB      0x88,0x90,0x98,0xA0,0xA8,0xB0,0xB8,0xC0,0xC8,0xD0,0xD8,0xE0,0xE8,0xF0,0xF8,0xFF
;==============================================================================
;===  FIRMWARE CHECKSUM  ======================================================
...
FIRMCHKSM   code    0x001000
    DB      0x58, 0x7a, 0x7c, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF            
;==============================================================================
;===  FIRMWARE ID  ============================================================
;==============================================================================
...
;------buttons---------------
ButtonStatusM: MACRO ButNr,ButReg,DiodeReg,RegBit ;macro sends status for chosen button
...
ButtonStatus
        banksel TXFIFOIN0
        ButtonStatusM   .1,ButtonsA,DiodesA,0  ;button 1, call macro, /macro_arg: Button_No, Button_REGISTER, Diode_REGISTER, Register_PIN/
        ButtonStatusM   .2,ButtonsA,DiodesA,1  ;button 2
        ButtonStatusM   .3,ButtonsA,DiodesA,2  ;button 3
        ButtonStatusM   .4,ButtonsA,DiodesA,3  ;button 4
        ButtonStatusM   .5,ButtonsA,DiodesA,4  ;button 5
        ButtonStatusM   .6,ButtonsA,DiodesA,5  ;button 6
        ButtonStatusM   .7,ButtonsA,DiodesA,6  ;button 7
        ButtonStatusM   .8,ButtonsA,DiodesA,7  ;button 8
        ButtonStatusM   .9,ButtonsB,DiodesB,0  ;button 9
        ButtonStatusM  .10,ButtonsB,DiodesB,1  ;button 10
        ButtonStatusM  .11,ButtonsB,DiodesB,2  ;button 11
        ButtonStatusM  .12,ButtonsB,DiodesB,3  ;button 12
        ButtonStatusM  .13,ButtonsB,DiodesB,4  ;button 13
        ButtonStatusM  .14,ButtonsB,DiodesB,5  ;button 14
    return
;------------
SendButtonStatus
...
SaveStatesToEeprom           
        ...
        bra     ExitSaveStateToEeprom
        ;save setpoint
        clrf    EEADRH                      ;point at eeprom high address             
